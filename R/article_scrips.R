...
#'
#' @md
#' @param variables a character string.
...
plot_age_viz <- function(variables) {
  ...
  age_dataset <- load(glue::glue("{getwd()}/data/age_dataset.Rdata"))
...
plot_religion_viz <- function() {
 # religion_dataset <- tidytemplate::load_it("data/religion_dataset.Rdata")
  religion_dataset <- load(glue::glue("{getwd()}/data/religion_dataset.Rdata"))
...
plot_educ_viz <- function() {
  ...
  education_dataset <- load(glue::glue("{getwd()}/data/education_dataset.Rdata"))
